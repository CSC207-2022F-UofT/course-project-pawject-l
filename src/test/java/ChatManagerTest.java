...
import userCase.ChatManager;
import entities.Chat;

import java.time.LocalDateTime;
import java.util.ArrayList;

import static userCase.ChatManager.generateUniqueChatID;

class ChatManagerTest {
    @Test
    public void generatedChatIDIsUnique() {
        String randChatID1 = generateUniqueChatID();
        String randChatID2 = generateUniqueChatID();
